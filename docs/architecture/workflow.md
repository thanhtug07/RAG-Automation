# Workflow — Enterprise Agent Platform

> Nguồn chi tiết: `D:\Downloads\files\docs\architecture\07-workflow-and-orchestration.md` + `00-system-overview-detailed.md`. File này là bản scaffold định hướng, không copy mù; coding agent đọc file nguồn để implement.
