# Frontend Services — README

> Domain: `frontend/services`. business logic layer — mapping DTOs. Architecture-first, Modular Monolith + Workers + Redis + Postgres + pgvector. Cấm microservices sớm.

## 1. Purpose
Frontend Services tồn tại để business logic layer — mapping dtos. Giữ boundary rõ để tách service sau này không rewrite logic.

## 2. Responsibilities
- Thực thi đúng phạm vi services; expose interface ổn định cho caller.
...
## Related
- Plan: `./services-plan.md`. Kiến trúc chi tiết: `docs/architecture/`.
