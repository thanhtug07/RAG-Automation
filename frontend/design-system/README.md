...
> Domain: `frontend/design-system`. tokens, shadcn-style components — theming, a11y. Architecture-first, Modular Monolith + Workers + Redis + Postgres + pgvector. Cấm microservices sớm.

## 1. Purpose
Design System tồn tại để tokens, shadcn-style components — theming, a11y. Giữ boundary rõ để tách service sau này không rewrite logic.

## 2. Responsibilities
- Thực thi đúng phạm vi design-system; expose interface ổn định cho caller.
...
## Related
- Plan: `./design-system-plan.md`. Kiến trúc chi tiết: `docs/architecture/`.
