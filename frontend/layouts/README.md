...
> Domain: `frontend/layouts`. app shell, nav, breadcrumbs — responsive shell. Architecture-first, Modular Monolith + Workers + Redis + Postgres + pgvector. Cấm microservices sớm.

## 1. Purpose
Layouts tồn tại để app shell, nav, breadcrumbs — responsive shell. Giữ boundary rõ để tách service sau này không rewrite logic.

## 2. Responsibilities
- Thực thi đúng phạm vi layouts; expose interface ổn định cho caller.
...
## Related
- Plan: `./layouts-plan.md`. Kiến trúc chi tiết: `docs/architecture/`.
