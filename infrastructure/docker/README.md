...
> Domain: `infrastructure/docker`. multi-stage images. Architecture-first, Modular Monolith + Workers + Redis + Postgres + pgvector. Cấm microservices sớm.

## 1. Purpose
Docker tồn tại để multi-stage images. Giữ boundary rõ để tách service sau này không rewrite logic.

## 2. Responsibilities
- Thực thi đúng phạm vi docker; expose interface ổn định cho caller.
...
## Related
- Plan: `./docker-plan.md`. Kiến trúc chi tiết: `docs/architecture/`.
